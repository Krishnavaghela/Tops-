...
select 
	concat_ws(" ",c.FirstName,c.LastName) as customer_name, o.OrderID, o.OrderDate 
from customers as c
join orders as o 
on o.CustomerID = c.CustomerID;
...
select c.CustomerID,
	concat_ws(" ",c.FirstName,c.LastName) as Cust_Name,o.OrderID 
from customers as c
join orders as o
...
select c.CustomerID,o.OrderID,c.Country
from customers as c
join orders as o
on c.CustomerID=o.CustomerID
group by o.OrderID
